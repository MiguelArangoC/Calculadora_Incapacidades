...
def _validar_numerico(valor, nombre_campo: str) -> None:
    """Valida que 'valor' sea numérico (int o float).

    Se separa de la validación de rango porque son dos preguntas distintas:
    '¿es un número?' vs '¿es un número válido?'.
    """
...
def validar_entradas(
    ...
    _validar_numerico(salario_mensual, "salario_mensual")
    _validar_numerico(dias_incapacidad, "dias_incapacidad")
